...
import io.canopy.platforms.desktop.graphics.nodes.visual.AnimatedSprite2D
import io.canopy.platforms.desktop.graphics.nodes.visual.Sprite2D
...
class RenderSystem(worldWidth: Int, worldHeight: Int) :
    TreeSystem(
        ...
        0,
        _root_ide_package_.io.canopy.platforms.desktop.graphics.nodes.visual.Sprite2D::class,
        _root_ide_package_.io.canopy.platforms.desktop.graphics.nodes.visual.AnimatedSprite2D::class
    ) {
    // Misc
    ...
    // Managers //
    private val cameraManager by lazyManager<io.canopy.platforms.desktop.graphics.managers.CameraManager>()
